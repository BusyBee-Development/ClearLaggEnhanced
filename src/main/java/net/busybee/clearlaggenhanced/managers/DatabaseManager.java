...
import net.busybee.clearlaggenhanced.database.DatabaseType;
import net.busybee.clearlaggenhanced.database.DatabaseInitializationException;
import net.busybee.clearlaggenhanced.database.datasource.DataSourceFactory;
import net.busybee.clearlaggenhanced.database.datasource.MySqlDataSourceFactory;
import net.busybee.clearlaggenhanced.database.datasource.SqliteDataSourceFactory;
import net.busybee.clearlaggenhanced.database.dialect.DatabaseDialect;
import net.busybee.clearlaggenhanced.database.dialect.MySqlDialect;
import net.busybee.clearlaggenhanced.database.dialect.SqliteDialect;
import net.busybee.clearlaggenhanced.database.migration.SchemaMigrator;
...
public class DatabaseManager implements AutoCloseable {
    ...
    private void initialize() {
        ...
        logger.info("Database: " + type.getDisplayName() + " connected (" + settings.describeTarget() + ")");
    }
